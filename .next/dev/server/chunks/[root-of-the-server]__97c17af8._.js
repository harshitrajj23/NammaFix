...
"[project]/app/api/complaints/resolve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data, error } = await supabase.from('complaints').update({
            status: 'completed'
        }).eq('id', complaint_id).eq('user_id', user.id) // Ensure only owner can resolve
        .select();
        if (error) {
        ...
        if (!data || data.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Complaint not found or ownership mismatch'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97c17af8._.js.map