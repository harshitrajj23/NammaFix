...
async function GET(request) {
    try {
        ...
        const { data: notifications, error } = await supabase.from('notifications').select('*').eq('user_id', user.id).order('created_at', {
            ascending: false
        });
        ...
        const formatted = notifications.map((n)=>({
                ...
                title: 'Government Response' // Adding a title as expected by NotificationPanel
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a7ca4c1._.js.map