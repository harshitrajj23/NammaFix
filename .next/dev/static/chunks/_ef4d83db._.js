...
function GovProblemCard({ id, title, description, location, timestamp, complaintId, occurrences, lastReportedAt, category, severity = 'medium', imageUrl, audioUrl, type = 'new' }) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-1 text-xs text-muted-foreground pt-2",
                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            severity && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                className: `text-[10px] uppercase font-bold ${SEVERITY_COLORS[severity]}`,
                                children: severity
                            }, void 0, false, {
                                fileName: "[project]/components/government/problem-card.tsx",
                                lineNumber: 106,
...
function NewProblemsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewProblemsPage.useEffect": ()=>{
            const fetchProblems = {
                "NewProblemsPage.useEffect.fetchProblems": async (silent = false)=>{
                    try {
                        if (!silent) setIsLoading(true);
                        const res = await fetch('/api/complaints?type=new');
                        ...
                        const sortedProblems = data.sort({
                            "NewProblemsPage.useEffect.fetchProblems.sortedProblems": (a, b)=>{
                                const sevA = severityOrder[a.severity?.toLowerCase()] ?? 2 // default medium
                                ;
                                const sevB = severityOrder[b.severity?.toLowerCase()] ?? 2;
                                if (sevA !== sevB) {
                                    return sevA - sevB;
                                }
                                return new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime();
                            }
                        }["NewProblemsPage.useEffect.fetchProblems.sortedProblems"]);
            ...
            const interval = setInterval({
                "NewProblemsPage.useEffect.interval": ()=>{
                    fetchProblems(true);
                }
            }["NewProblemsPage.useEffect.interval"], 10000);
            return ({
...
//# sourceMappingURL=_ef4d83db._.js.map